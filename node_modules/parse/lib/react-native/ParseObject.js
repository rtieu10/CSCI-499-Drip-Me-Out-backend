        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return _regenerator.default.awrap(this.save(null, options));
            ...
            case 5:
              ...
              _context2.next = 10;
              return _regenerator.default.awrap(_EventuallyQueue.default.save(this, options));
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return _regenerator.default.awrap(this.destroy(options));
            ...
            case 5:
              ...
              _context3.next = 10;
              return _regenerator.default.awrap(_EventuallyQueue.default.destroy(this, options));
